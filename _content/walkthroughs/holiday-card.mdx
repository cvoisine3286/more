...
-   `box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.1)` sets a shadow
...
Here we have a couple of new things.
...
Okay, let's add the signature form after the "To: You" text. Here'
